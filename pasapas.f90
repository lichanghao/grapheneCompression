...
!!$!!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
!!$mesh0%x_indent=BCs%xc(1)
!!$mesh0%y_indent=BCs%xc(2)
!!$mesh0%z_indent=BCs%xc(3)+15
!!$ 
!!$!write(*,*)mesh0%x_indent,mesh0%y_indent,mesh0%z_indent
!!$
!!$!!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
xlength=maxval(x0(3*BCs%mnodBC(:,1)-2))-minval(x0(3*BCs%mnodBC(:,1)-2))
!write(*,*)"placeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee 2"
...
!write(*,*)"placeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee 1"
...
!!!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
!      mesh0%z_indent=mesh0%z_indent-0.5
!!!@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
   endif
...
!  mesh0%nnflag=1 
   ...
   !     write(*,*)"placeeeeeeeeeeeeeeeeeeeeeeeeeeee   1"
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ! OUTPUT
   IF(ID.EQ.0) THEN
      ...
      if ((BCs%nCodeLoad.eq.-1).or.(BCs%nCodeLoad.eq.0).or.(BCs%nCodeLoad.eq.1).or. &
           ...
           (BCs%nCodeLoad.eq.13).or.(BCs%nCodeLoad.eq.8).or.(BCs%nCodeLoad.eq.10).or.(BCs%nCodeLoad.eq.3))then
